...
var player_service_1 = __webpack_require__(208);
var player_1 = __webpack_require__(572);
var PlayerComponent = /** @class */ (function () {
    function PlayerComponent(playerService) {
        this.playerService = playerService;
        this.selectedPlayer = new player_1.Player();
        this.players = [];
        this.messages = [];
    }
    ...
    PlayerComponent.prototype.getPlayers = function () {
        var _this = this;
        this.playerService
            .getPlayers()
            ...
            _this.messages.push({ severity: 'error', summary: 'Error getting players.', detail: error });
        });
    };
    PlayerComponent.prototype.getKeys = function (map) {
        var array = [];
        if (map !== undefined) {
    ...
    ], PlayerComponent.prototype, "messages", void 0);
...
var PlayerService = /** @class */ (function () {
    ...
    PlayerService.prototype.extractPlayer = function (response) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__(2);
var ranking_service_1 = __webpack_require__(210);
var RankingComponent = /** @class */ (function () {
    ...
    RankingComponent.prototype.getRanking = function () {
        var _this = this;
        this.rankingService
            .getRanking()
            ...
            _this.messages.push({ severity: 'error', summary: 'Error getting ranking.', detail: error });
        });
    };
    RankingComponent.prototype.lookupRowStyleClass = function (ranking) {
        if (ranking.rank == 1) {
            return "firstplace";
        }
    ...
    __decorate([
        core_1.Input(),
        __metadata("design:type", Array)
    ], RankingComponent.prototype, "messages", void 0);
...
var RankingService = /** @class */ (function () {
    ...
    RankingService.prototype.extractRanking = function (response) {
        return response.json();
    };
    RankingService.prototype.handleError = function (error) {
        var errMsg;
        if (error instanceof http_1.Response) {
            errMsg = error.json().message || '';
        }
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__(2);
var statistics_service_1 = __webpack_require__(212);
var StatisticsComponent = /** @class */ (function () {
    ...
    StatisticsComponent.prototype.getStatistics = function () {
        ...
        this.statisticsService
            ...
            _this.getPer16(statistics);
            _this.getPer8(statistics);
            _this.getPer4(statistics);
            _this.getPer2(statistics);
            _this.getPer1(statistics);
        }, function (error) {
            _this.messages.push({ severity: 'error', summary: 'Error getting statistics.', detail: error });
        });
    };
    StatisticsComponent.prototype.getPer16 = function (statistics) {
        this.per16 = {
    ...
    StatisticsComponent.prototype.getPer8 = function (statistics) {
        this.per8 = {
    ...
    StatisticsComponent.prototype.getPer4 = function (statistics) {
        this.per4 = {
    ...
    StatisticsComponent.prototype.getPer2 = function (statistics) {
        this.per2 = {
    ...
    StatisticsComponent.prototype.getPer1 = function (statistics) {
        this.per1 = {
    ...
    __decorate([
        core_1.Input(),
        __metadata("design:type", Array)
    ], StatisticsComponent.prototype, "messages", void 0);
...
__webpack_require__(99);
__webpack_require__(100);
var statistics_1 = __webpack_require__(577);
var StatisticsService = /** @class */ (function () {
    ...
    StatisticsService.prototype.extractStatistics = function (response) {
        var statistics = new statistics_1.Statistics();
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__(2);
var ScoringComponent = /** @class */ (function () {
...
var core_1 = __webpack_require__(2);
var app_module_1 = __webpack_require__(558);
...
var http_1 = __webpack_require__(61);
var animations_1 = __webpack_require__(562);
var http_2 = __webpack_require__(61);
var cache_remover_1 = __webpack_require__(564);
// Application components
var breadcrumb_component_1 = __webpack_require__(565);
var home_component_1 = __webpack_require__(569);
var player_component_1 = __webpack_require__(207);
var player_service_1 = __webpack_require__(208);
var ranking_component_1 = __webpack_require__(209);
var ranking_service_1 = __webpack_require__(210);
var statistics_component_1 = __webpack_require__(211);
var statistics_service_1 = __webpack_require__(212);
var scoring_component_1 = __webpack_require__(213);
var primeng_1 = __webpack_require__(135);
// Providers
var app_routes_1 = __webpack_require__(648);
var primeng_2 = __webpack_require__(135);
var CustomReuseStrategy_1 = __webpack_require__(649);
var AppModule = /** @class */ (function () {
    function AppModule() {
    }
    AppModule = __decorate([
        core_1.NgModule({
            imports: [platform_browser_1.BrowserModule, primeng_1.ListboxModule, animations_1.BrowserAnimationsModule, primeng_1.ChartModule, forms_1.FormsModule, forms_1.ReactiveFormsModule, http_1.HttpModule, primeng_2.DataTableModule, primeng_2.DialogModule, primeng_2.GrowlModule, primeng_2.CalendarModule, primeng_2.CheckboxModule, primeng_2.DropdownModule, primeng_2.TriStateCheckboxModule, primeng_2.MultiSelectModule, primeng_2.SharedModule, primeng_2.TooltipModule, primeng_2.ButtonModule, primeng_2.TabViewModule, router_1.RouterModule.forRoot(app_routes_1.APP_ROUTES)],
            exports: [router_1.RouterModule],
            declarations: [home_component_1.HomeComponent, breadcrumb_component_1.BreadcrumbComponent, ranking_component_1.RankingComponent, statistics_component_1.StatisticsComponent, scoring_component_1.ScoringComponent, player_component_1.PlayerComponent],
            bootstrap: [home_component_1.HomeComponent],
            providers: [{ provide: http_2.RequestOptions, useClass: cache_remover_1.CustomRequestOptions }, player_service_1.PlayerService, ranking_service_1.RankingService, statistics_service_1.StatisticsService, { provide: router_1.RouteReuseStrategy, useClass: CustomReuseStrategy_1.CustomReuseStrategy }]
        })
    ], AppModule);
    return AppModule;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_tslib__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_animations__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__angular_animations_browser__ = __webpack_require__(563);
/**
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_tslib__ = __webpack_require__(38);
/**
 * @license Angular v5.2.2
 * (c) 2010-2018 Google, Inc. https://angular.io/
 * License: MIT
...
var breadcrumb_1 = __webpack_require__(566);
var BreadcrumbComponent = /** @class */ (function () {
    ...
    BreadcrumbComponent.prototype.getBreadCrumbs = function (event) {
        var breadcrumbs = event.urlAfterRedirects.split("/");
        var newBreadcrumbs = [this.getBreadCrumb("/", "Hjem")];
        var url = "";
        for (var _i = 0, breadcrumbs_1 = breadcrumbs; _i < breadcrumbs_1.length; _i++) {
            var breadcrumbStr = breadcrumbs_1[_i];
            if (breadcrumbStr !== '') {
    ...
    BreadcrumbComponent.prototype.getBreadCrumb = function (url, name) {
...
module.exports = "<div class=\"panel panel-default breadcrumb-container\">\n    <div class=\"container-fluid\">\n      <ol class=\"breadcrumb\">\n          <li *ngFor=\"let breadcrumb of breadcrumbs\"><a routerLink=\"{{breadcrumb.url}}\" routerLinkActive=\"active\">{{breadcrumb.name}}</a></li>\n      </ol>\n    </div>\n</div>\n";
...
module.exports = "<nav class=\"navbar navbar-default\">\n    <div class=\"container-fluid\">\n        <div class=\"navbar-header\">\n            <button type=\"button\" class=\"navbar-toggle collapsed\" data-toggle=\"collapse\" data-target=\"#navbar\" aria-expanded=\"false\" aria-controls=\"navbar\">\n                <span class=\"sr-only\">Toggle navigation</span>\n                <span class=\"icon-bar\"></span>\n                <span class=\"icon-bar\"></span>\n                <span class=\"icon-bar\"></span>\n            </button>\n            <a class=\"navbar-brand\" routerLink=\"\" routerLinkActive=\"active\">World cup challenge 2018</a>\n        </div>\n        <div id=\"navbar\" class=\"collapse navbar-collapse\">\n            <ul class=\"nav navbar-nav navbar-right\">\n                <li><a routerLink=\"/rangering\" routerLinkActive=\"active\" routerLinkActive=\"active\">Rangering</a></li>\n                <li><a routerLink=\"/statistikk\" routerLinkActive=\"active\" routerLinkActive=\"active\">Statistikk</a></li>\n                <li><a routerLink=\"/spillere\" routerLinkActive=\"active\" routerLinkActive=\"active\">Spillere</a></li>\n                <li><a routerLink=\"/informasjon\" routerLinkActive=\"active\" routerLinkActive=\"active\">Beskrivelse</a></li>\n            </ul>\n        </div>\n    </div>\n</nav>\n<breadcrumbComponent></breadcrumbComponent>\n<div class=\"main\">\n  <div class=\"container-fluid\">\n      <router-outlet ></router-outlet>\n  </div>\n</div>\n";
...
var Player = /** @class */ (function () {
    function Player() {
        this.per1Countries = new Map();
        this.per2Countries = new Map();
        this.per4Countries = {};
        this.per8Countries = {};
        this.per16Countries = {};
    }
...
module.exports = "<div class=\"main\">\n  <div class=\"container-fluid\">\n    <div class=\"row\">\n      <div class=\"col-sm-4\">\n        <p-listbox [options]=\"players\" [(ngModel)]=\"selectedPlayer\"></p-listbox>\n      </div>\n      <div class=\"col-sm-8\">\n        <div class=\"row\">\n          <div class=\"col-sm-8\">\n            <h3>Spiller</h3>\n            <p>{{ selectedPlayer.name }}\n          </div>\n          <div class=\"col-sm-4\">\n            <h3>Målpoeng</h3>\n            <span class=\"text-center\"><h4 class=\"label label-success\">{{ selectedPlayer.goalPoints }}</h4></span>\n          </div>\n        </div>\n        <div class=\"row\">\n          <h3>Åttendedelsfinale</h3>\n          <div *ngIf=\"selectedPlayer !== undefined && selectedPlayer.per16Countries !== undefined\">\n            <div class=\"col-md-6\" *ngFor=\"let country of getKeys(selectedPlayer.per16Countries)\" [ngClass]=\"selectedPlayer.per16Countries[country]?'label label-success':'label label-danger'\">\n               <label>{{ country }}</label>\n               <span *ngIf=\"selectedPlayer.per16Countries[country]\" class=\"glyphicon glyphicon-ok\"></span>\n               <span *ngIf=\"!selectedPlayer.per16Countries[country]\" class=\"glyphicon glyphicon-remove\"></span>\n            </div>\n          </div>\n        </div>\n        <div class=\"row\">\n          <h3>Kvartfinale</h3>\n          <div *ngIf=\"selectedPlayer !== undefined && selectedPlayer.per8Countries !== undefined\">\n            <div class=\"col-md-6\" *ngFor=\"let country of getKeys(selectedPlayer.per8Countries)\" [ngClass]=\"selectedPlayer.per16Countries[country]?'label label-success':'label label-danger'\">\n               <label>{{ country }}</label>\n               <span *ngIf=\"selectedPlayer.per8Countries[country]\" class=\"glyphicon glyphicon-ok\"></span>\n               <span *ngIf=\"!selectedPlayer.per8Countries[country]\" class=\"glyphicon glyphicon-remove\"></span>\n            </div>\n          </div>\n        </div>\n        <div class=\"row\">\n          <h3>Semifinale</h3>\n          <div *ngIf=\"selectedPlayer !== undefined && selectedPlayer.per4Countries !== undefined\">\n            <div class=\"col-md-6\" *ngFor=\"let country of getKeys(selectedPlayer.per4Countries)\" [ngClass]=\"selectedPlayer.per16Countries[country]?'label label-success':'label label-danger'\">\n               <label>{{ country }}</label>\n               <span *ngIf=\"selectedPlayer.per4Countries[country]\" class=\"glyphicon glyphicon-ok\"></span>\n               <span *ngIf=\"!selectedPlayer.per4Countries[country]\" class=\"glyphicon glyphicon-remove\"></span>\n            </div>\n          </div>\n        </div>\n        <div class=\"row\">\n          <h3>Finale</h3>\n          <div *ngIf=\"selectedPlayer !== undefined && selectedPlayer.per2Countries !== undefined\">\n            <div class=\"col-md-6\" *ngFor=\"let country of getKeys(selectedPlayer.per2Countries)\" [ngClass]=\"selectedPlayer.per16Countries[country]?'label label-success':'label label-danger'\">\n               <label>{{ country }}</label>\n               <span *ngIf=\"selectedPlayer.per2Countries[country]\" class=\"glyphicon glyphicon-ok\"></span>\n               <span *ngIf=\"!selectedPlayer.per2Countries[country]\" class=\"glyphicon glyphicon-remove\"></span>\n            </div>\n          </div>\n        </div>\n        <div class=\"row\">\n          <h3>Vinner</h3>\n          <div *ngIf=\"selectedPlayer !== undefined && selectedPlayer.per1Countries !== undefined\">\n            <div class=\"col-md-6\" *ngFor=\"let country of getKeys(selectedPlayer.per1Countries)\" [ngClass]=\"selectedPlayer.per16Countries[country]?'label label-success':'label label-danger'\">\n               <label>{{ country }}</label>\n               <span *ngIf=\"selectedPlayer.per1Countries[country]\" class=\"glyphicon glyphicon-ok\"></span>\n               <span *ngIf=\"!selectedPlayer.per1Countries[country]\" class=\"glyphicon glyphicon-remove\"></span>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n";
...
module.exports = "<div class=\"main\">\n  <div class=\"container-fluid\">\n    <p-dataTable [value]=\"ranking\" [rowStyleClass]=\"lookupRowStyleClass\">\n      <p-column field=\"rank\" header=\"Plassering\" ></p-column>\n      <p-column field=\"name\" header=\"Navn\" ></p-column>\n      <p-column field=\"totalpoints\" header=\"Totalt antall poeng\" ></p-column>\n      <p-column field=\"per16points\" header=\"Poeng åttendelsfinalen\" styleClass=\"grey\"></p-column>\n      <p-column field=\"per8points\" header=\"Poeng kvartfinalen\" styleClass=\"grey\"></p-column>\n      <p-column field=\"per4points\" header=\"Poeng semifinalen\" styleClass=\"grey\"></p-column>\n      <p-column field=\"per2points\" header=\"Poeng finalen\" styleClass=\"grey\"></p-column>\n      <p-column field=\"per1points\" header=\"Poeng vinner\" styleClass=\"grey\"></p-column>\n      <p-column field=\"goalpoints\" header=\"Poeng for mål\" styleClass=\"grey\"></p-column>\n  </p-dataTable>\n  </div>\n</div>\n";
...
module.exports = "<div class=\"main\">\n  <div class=\"container-fluid\">\n      <p-tabView>\n        <p-tabPanel header=\"Vinner\">\n          <p-chart type=\"bar\" width=\"1400px\" height=\"600px\" [data]=\"per1\" [options]=\"options\"></p-chart>\n          <h3>Fordeling av hvor mange spillere som har valgt hvilke vinnere.</h3>\n        </p-tabPanel>\n        <p-tabPanel header=\"Finaler\">\n          <p-chart type=\"bar\" width=\"1400px\" height=\"600px\" [data]=\"per2\" [options]=\"options\"></p-chart>\n          <h3>Fordeling av hvor mange spillere som har valgt hvilke finalister.</h3>\n        </p-tabPanel>\n        <p-tabPanel header=\"Semifinaler\">\n          <p-chart type=\"bar\" width=\"1400px\" height=\"600px\" [data]=\"per4\" [options]=\"options\"></p-chart>\n          <h3>Fordeling av hvor mange spillere som har valgt hvilke semifinalister.</h3>\n        </p-tabPanel>\n        <p-tabPanel header=\"Kvartfinaler\">\n          <p-chart type=\"bar\" width=\"1400px\" height=\"600px\" [data]=\"per8\" [options]=\"options\"></p-chart>\n          <h3>Fordeling av hvor mange spillere som har valgt hvilke kvartfinalister.</h3>\n        </p-tabPanel>\n        <p-tabPanel header=\"8 dels finaler\">\n          <p-chart type=\"bar\" width=\"1400px\" height=\"600px\" [data]=\"per16\" [options]=\"options\"></p-chart>\n          <h3>Fordeling av hvor mange spillere som har valgt hvilke åttendelsfinalister.</h3>\n        </p-tabPanel>\n      </p-tabView>\n  </div>\n</div>\n";
...
module.exports = "<div class=\"main\">\n  <div class=\"container-fluid\">\n    <h3>Regler</h3>\n    <table>\n      <thead>\n        <th>Regel</th>\n      </thead>\n      <tbody>\n        <tr>\n          <td>Hver spiller velger 16 land for åttendedelsfinalen.</td>\n        </tr>\n        <tr>\n          <td>Hver spiller velger 8 land for kvartfinalen.</td>\n        </tr>\n        <tr>\n          <td>Hver spiller velger 4 land for semifinalen.</td>\n        </tr>\n        <tr>\n          <td>Hver spiller velger 2 land for finalen.</td>\n        </tr>\n        <tr>\n          <td>Hver spiller velger hvem de tror vinner finalen.</td>\n        </tr>\n        <tr>\n          <td>Hver spiller velger to land som gir poeng hver gang de skorer.</td>\n        </tr>\n      </tbody>\n    </table>\n    <p></p>\n    <h3>Poeng system for land som når sluttspillet.</h3>\n    <table>\n      <thead>\n        <th>Beskrivelse</th>\n        <th>Poeng</th>\n      </thead>\n      <tbody>\n        <tr>\n          <td>Land når åttendedelsfinalen.</td>\n          <td>1 poeng</td>\n        </tr>\n        <tr>\n          <td>Land når kvartfinalen.</td>\n          <td>2 poeng</td>\n        </tr>\n        <tr>\n          <td>Land når semifinalen.</td>\n          <td>3 poeng</td>\n        </tr>\n        <tr>\n          <td>Land når finalen.</td>\n          <td>4 poeng</td>\n        </tr>\n        <tr>\n          <td>Land vinner finalen.</td>\n          <td>5 poeng</td>\n        </tr>\n      </tbody>\n    </table>\n    <p>Poengene akkumulerer så et land som når kvartfinalen får 1 poeng for åttendedelsfinalen og 2 poeng for kvartfinalen.</p>\n    <p></p>\n    <p></p>\n    <h3>Poeng system for land som skorer mål.</h3>\n    <p>Hver spiller kan velge to land. Hvert mål disse landene skorer(ikke straffespark konkuranse) så får man 1 poeng.</p>\n  </div>\n</div>\n";
...
exports.APP_ROUTES = [
    ...
    { path: 'rangering', component: ranking_component_1.RankingComponent, data: { cachable: false } },
    { path: 'statistikk', component: statistics_component_1.StatisticsComponent, data: { cachable: false } },
    { path: 'informasjon', component: scoring_component_1.ScoringComponent, data: { cachable: false } },
    { path: 'spillere', component: player_component_1.PlayerComponent, data: { cachable: false } }
];
...
//# sourceMappingURL=app.2d9dd34cb99f60716d73.js.map